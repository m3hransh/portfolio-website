...
export const GitHubLink = 'https://github.com/m3hransh'
export const LinkedIn = 'https://www.linkedin.com/in/mohammad-mehran-shahidi'
const TwitterLink = 'https://twitter.com/m3hransh'
